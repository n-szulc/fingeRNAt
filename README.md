...
[Sample YAML file](code/custom-interactions.yaml) is provided with the fingeRNAt code. To validate your yaml file syntax you can use [https://codebeautify.org/yaml-validator](an online validator).
