...
if __name__ == "__main__":
    ...
    structure = pybel.readfile(extension_structure,filename_RNA).next()
    ...
    if fingerprint == 'SIMPLE' or fingerprint == 'PBS':
        ...
        for residue in openbabel.OBResidueIter(structure.OBMol): # Loop over all RNA residues
            ...
            for ligand_name, ligand_atoms in ligands_all_atoms.iteritems():
        ...
        for residue in openbabel.OBResidueIter(structure.OBMol): # Loop over all RNA residue to calculate hydrogen bondings, halogen bondings & cation-anion interactions
            ...
            for ligand_name_HB, ligand_values_HB in ligands_hba_hbd.iteritems():
            ...
            for ligand_name_HAL, ligand_values_HAL in ligands_HAL.iteritems():
            ...
            for ligand_name_CA, ligand_values_CA in ligands_CA.iteritems():
